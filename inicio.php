        ...
        <div class="w3-main w3-container">
            ...
            <div class="w3-panel w3-padding-large w3-card-4 w3-light-dark">
                ...
                <?php
                    ...
                    $sql = "SELECT c.id as Id, c.Nome as Nome, r.Nome as Raca, c.Ano_nascimento as Ano_nascimento, c.Porte as Porte, c.Imagem as Imagem FROM cachorro c, raca r where c.Id_Raca = r.Id and c.Apto = 'on' and Adotado = ''";
