            ...
            <div class="w3-code cssHigh notranslate">
				...
				?>
								<div class="w3-container w3-theme">
									<h2>Exclusão do Cachorro Cod. = [<?php echo $row['Id']; ?>]</h2>
								</div>
								<form class="w3-container" action="deletarCachorro_exe.php" method="post" onsubmit="return check(this.form)">
									...
									<p>
									<label class="w3-text-deep-purple"><b>Raça: </b><?php echo $row['Raca']; ?></label></p>
									<p>
									<label class="w3-text-deep-purple"><b>Ano de Nascimento: </b><?php echo $row['Ano_Nascimento'] ?></label></p>
									<p>
									<label class="w3-text-deep-purple"><b>Porte: </b><?php echo $row['Porte']; ?></label></p>
									<p>
									<input type="submit" value="Confirma exclusão?" class="w3-btn w3-red" >
									<input type="button" value="Cancelar" class="w3-btn w3-theme" onclick="window.location.href='mostrarCachorro.php'"></p>
								</form>
			<?php 
							}
						}
